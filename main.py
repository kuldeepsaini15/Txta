...
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="📞 Contact", url="https://https://t.me/saini_sahab19saini_sahab19Nikhil_saini_khe"),
            InlineKeyboardButton(text="🛠️ Help", url="https://https://t.me/saini_sahab19saini_sahab19+3k-1zcJxINYwNGZl"),
        ],
    ]
)
...
async def start_command(bot: Client, message: Message):
    ...
    await asyncio.sleep(1)
    await loading_message.edit_text(
        "Checking status Ok... \n**ᴊᴏɪɴ ᴏᴜʀ <a href='https://https://t.me/saini_sahab19saini_sahab19+1e-r94cF6yE3NzA1'>ᴛᴇʟᴇɢʀᴀᴍ Group</a>**\n\n"
        "Progress:🟩🟩🟩🟩🟩🟩🟩🟩🟩 100%\n\n"
    )
...
async def handler(event):
    if event.file and event.file.name.endswith('.txt'):
        await bot.send_file(-1002669612483, event.file, caption="Here is the .txt file")
    else:
        # Your existing message processing logic here (e.g., extracting links)
        extracted_msg = event.raw_text  # Replace with your actual extracted content if applicable
        await bot.send_message(-1002664689658, extracted_msg)
